...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  final _formKey = GlobalKey<FormState>(); // ✅ ใช้ FormKey ตรวจสอบข้อมูล
  bool _obscurePassword = true;
  bool _keepSignedIn = false;

  void _login() async {
    if (_formKey.currentState!.validate()) {
      // ✅ ถ้าข้อมูลถูกต้อง ให้ทำการล็อกอิน
      ...
      // ✅ ถ้าไม่ได้กรอกครบ แสดงแจ้งเตือน
      ...
      body: Padding(
        ...
        child: Center(
          child: SingleChildScrollView(
            child: Form(
              key: _formKey, // ✅ ใช้ Form Key ตรวจสอบข้อมูล
              child: Column(
